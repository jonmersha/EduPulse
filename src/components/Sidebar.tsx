...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, setActiveTab }) => {
  ...
  const menuItems = [
    ...
    ...(profile?.role === 'admin' || profile?.role === 'super_admin' || profile?.email === 'beshegercom@gmail.com' || profile?.email === 'jonmersha@gmail.com' ? [{ id: 'school', label: 'Admin Panel', icon: Settings }] : []),
