...
export const ParentView: React.FC = () => (
  <div className="space-y-8">
    <header>
      ...
      <p className="text-zinc-500 dark:text-zinc-400 dark:text-zinc-500 dark:text-zinc-400 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-400 dark:text-zinc-500 mt-1">Track your children's academic progress and attendance.</p>
    </header>
    <div className="bg-white dark:bg-zinc-900 dark:bg-zinc-900 border border-black/5 rounded-3xl p-12 text-center text-zinc-400 dark:text-zinc-500 dark:text-zinc-500 dark:text-zinc-400 dark:text-zinc-500">
